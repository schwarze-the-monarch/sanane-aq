...
message.channel.send(new Discord.MessageEmbed()
  .addField("İşlem Başarılı",`<a:VN_basarili:777605383153647666> Mod-Log Başarılı Bir Şekilde Sıfırlandı`)
  .setColor("RED")
 );
return
}
...
message.channel.send(new Discord.RichEmbed()
  .addField("İşlem Başarılı",`<a:VN_basarili:777605383153647666> Mod-Log Kanalı ${logk} Olarak Ayarlandı`)
  .setColor("RED")
);
};
exports.conf = {
